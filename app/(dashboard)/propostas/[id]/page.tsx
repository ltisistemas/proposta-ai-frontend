  ...
  return (
    <>
      ...
      <div className="space-y-6 max-w-6xl mx-auto pb-24">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 dark:text-[#cbd5e1]">
          <Link
            href="/propostas"
            className="hover:text-blue-600 dark:hover:text-[#bd93f9] transition-colors flex items-center gap-1.5"
          >
            <ArrowLeft className="w-3.5 h-3.5" />
            <span>Minhas Propostas</span>
          </Link>
          <span>/</span>
          <span className="text-slate-800 dark:text-[#f8f8f2] font-mono">{proposta.numero}</span>
        </div>

        {/* Clean Executive Header Card */}
        <div className="bg-white dark:bg-[#343746] border border-slate-200/90 dark:border-[#44475a] p-4 sm:p-6 rounded-3xl shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-2">
              <div className="flex flex-wrap items-center gap-3">
                <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-[#f8f8f2] tracking-tight">
                  {proposta.cliente_nome}
                </h1>
                <Badge variant={proposta.status as BadgeVariant} />
                {!isPro && (
                  <span className="text-[11px] font-semibold text-slate-500 dark:text-[#cbd5e1] bg-slate-100 dark:bg-[#282a36] px-2 py-0.5 rounded-full border border-slate-200 dark:border-[#44475a]">
                    Modo Notepad Free
                  </span>
                )}
                {isAssinada && (
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500 dark:text-[#cbd5e1] font-medium">
                <span className="font-mono bg-slate-100 dark:bg-[#282a36] px-2.5 py-0.5 rounded-md text-slate-700 dark:text-[#8be9fd] font-bold">
                  {proposta.numero}
                </span>
                ...
                <span className="flex items-center gap-1">
                  <Calendar className="w-3.5 h-3.5 text-slate-400 dark:text-[#94a3b8]" />
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {!isPro && <Lock className="w-3 h-3 text-slate-400 dark:text-[#94a3b8] ml-1" />}
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#F1F5F9] dark:bg-[#21222c] border border-slate-200/90 dark:border-[#44475a] rounded-2xl sm:rounded-3xl p-1.5 sm:p-6 md:p-10 shadow-sm flex flex-col items-center overflow-x-hidden w-full">
          <div className="w-full max-w-4xl bg-white dark:bg-[#282a36] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-slate-200/80 dark:border-[#44475a] min-h-[85vh]">
            <iframe
