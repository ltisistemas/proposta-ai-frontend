...
export default function VisualizarPropostaPage({
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-16">
      {/* Top Action Header */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-slate-900/90 border border-slate-800 p-5 rounded-3xl backdrop-blur-xl">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 sm:p-8 backdrop-blur-xl shadow-2xl">
        <div
