    ...
    <div className="min-h-screen bg-[#FBFBFA] dark:bg-[#282a36] text-slate-900 dark:text-[#f8f8f2] flex flex-col font-sans selection:bg-blue-500 selection:text-white dark:selection:bg-[#bd93f9] dark:selection:text-[#282a36] transition-colors duration-200">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-8">
        ...
        <div className="space-y-3 pb-8 border-b border-slate-200 dark:border-[#44475a]">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-50 dark:bg-purple-950/40 text-blue-700 dark:text-[#bd93f9] border border-blue-200 dark:border-purple-800/40">
        ...
        <div className="bg-white dark:bg-[#343746] border border-slate-200/90 dark:border-[#44475a] rounded-3xl p-6 sm:p-8 shadow-xs space-y-4 text-sm text-slate-700 dark:text-[#f8f8f2] leading-relaxed">
          ...
          <p>
            ...
            <Link href="/privacidade" className="text-blue-600 dark:text-[#8be9fd] font-bold hover:underline">
        ...
        <div className="space-y-8 text-sm text-slate-700 dark:text-[#f8f8f2] leading-relaxed">
          ...
          <section className="bg-white dark:bg-[#343746] border border-slate-200/90 dark:border-[#44475a] rounded-3xl p-6 sm:p-8 shadow-xs space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-slate-600 dark:text-[#cbd5e1]">
        ...
        <div className="p-6 rounded-2xl bg-slate-100 dark:bg-[#21222c] border border-slate-200 dark:border-[#44475a] text-center space-y-2">
          <p className="font-bold text-slate-800 dark:text-[#f8f8f2] text-sm">
