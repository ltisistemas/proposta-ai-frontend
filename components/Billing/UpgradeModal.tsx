...
export function UpgradeModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size={step === "PIX" ? "lg" : "md"}>
      <div className="text-left space-y-6 pt-1">
          ...
          <>
            ...
            <div className="bg-gradient-to-br from-blue-900 via-blue-950 to-slate-900 rounded-2xl p-5 text-white border border-blue-500/30 shadow-lg relative overflow-hidden">
              <div className="flex items-baseline justify-between mb-4 pb-3 border-b border-white/10">
                ...
                <span className="text-[11px] bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 px-2.5 py-1 rounded-lg font-bold">
                  PIX Instantâneo
                </span>
              </div>
        ...
        {step === "PIX" && pixData && (
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-50 border border-amber-200/60 text-amber-800 text-[11px] font-semibold animate-pulse">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-center">
              {/* QR Code Container */}
              <div className="md:col-span-5 flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-200/80 rounded-2xl shadow-inner">
              ...
              <div className="md:col-span-7 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-xs font-mono bg-slate-100 border border-slate-200 rounded-xl text-slate-700 select-all focus:outline-hidden"
                    />
                    <Button
                ...
                {/* Steps guide */}
                <div className="bg-blue-50/70 border border-blue-100 rounded-xl p-3 text-xs text-slate-700 space-y-1.5">
                ...
                <div className="pt-1">
                  <Button
                    ...
                    variant="secondary"
                    size="sm"
                    className="w-full text-xs font-semibold border-dashed border-emerald-300 bg-emerald-50/70 text-emerald-800 hover:bg-emerald-100/80 justify-center"
        ...
        {step === "SUCCESS" && (
          <div className="text-center py-4 space-y-5">
            <div className="w-16 h-16 rounded-full bg-emerald-100 border-2 border-emerald-300 flex items-center justify-center mx-auto shadow-md shadow-emerald-500/10">
            ...
            <div className="p-4 bg-slate-50 border border-slate-200/80 rounded-2xl max-w-md mx-auto grid grid-cols-2 gap-2 text-left text-xs text-slate-700">
              <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="primary"
              size="lg"
              className="w-full font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-600/30 justify-center"
              rightIcon={<ArrowRight className="w-4 h-4" />}
            >
