...
export function DigitalCertificate({
  ...
  return (
    <div className="my-8 rounded-2xl border-2 border-emerald-500/30 bg-gradient-to-br from-emerald-50/70 via-white to-blue-50/50 p-6 text-slate-900 shadow-sm relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-emerald-200/60 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-800 uppercase tracking-wider bg-emerald-100/80 px-2 py-0.5 rounded-full border border-emerald-200">
