...
export async function criarCobrancaPixTransparente(
    ...
    if (apiKey && !apiKey.startsWith("mock_") && !apiKey.startsWith("test_mock")) {
      const response = await client.post("/transparents/create", {
        ...
        data: {
          ...
          description:
            payload.description || "Assinatura ViraPropo AI! Pro - Mensal",
  ...
  const samplePixCode = `00020126580014BR.GOV.BCB.PIX0136d2b4e5f6-7890-abcd-ef12-${chargeId.substring(9, 21)}520400005303986540545.905802BR5915VIRAPROPO AI PRO6009SAO PAULO62070503***6304`;
